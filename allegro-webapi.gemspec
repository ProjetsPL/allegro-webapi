...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'Api wrapper for allegro webapi written in ruby. Make it supereasy to interact with allegro api.'
  spec.summary       = 'API WRAPPER for allegro web api'

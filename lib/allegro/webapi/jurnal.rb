  ...
  module WebApi
    module Jurnal
      def do_get_site_journal(starting_point = 0, info_type = 0)
        message = { session_handle: @web_api_client.session_handle, starting_point: starting_point, info_type: info_type }
        @web_api_client
      ...
      def do_get_site_journal_deals(journal_start = 0)
        message = { session_id: @web_api_client.session_handle, journal_start: journal_start }
        @web_api_client

  ...
  module WebApi
    module Account
      def do_get_favourite_categories
        message = {session_handle: @api_client.session_handle}
        @api_client
      ...
      def do_get_my_not_sold_items(sort_type = 0, sort_order = 0, filter_format = 0, filter_from_end = 0, filter_auto_listing = 0, filter_price_from = 0, filter_price_to = 0, search_value = "", category_id = 0, item_ids = [], page_size = 0, page_number = 0)
        message = {
          session_id: @api_client.session_handle,
          sort_options: { sort_type: sort_type, sort_order: sort_order },
          filterOptions: {
